            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <!-- Post content-->
                        <section class="mb-5">
                            <p  align= "justify" class="fs-5 mb-4"><?php echo $viewdetails->Description;?></p>
                    ...
                    <?php endif;?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="comment" id="comment"  placeholder="Type your message here" rows="4"></textarea>
                                </div>
			...
			$.ajax({
               ...
               $('#contactForm').trigger('reset');
					if(dataResult.statusCode==200){
						...
						$("#success").show();
						$('#success').html('Data is added successfully!'); 						
					}
