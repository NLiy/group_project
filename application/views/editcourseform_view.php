<form id="formEditCourse" action="<?php echo base_url(); ?>EditCourse/updatecourse/<?php echo $course->course_code; ?>" method="post" style="border:1px solid #ccc">
	...
	<div class="container">
		<form>
			<div class="form-group">
		  	...
		  	<div>
		  		<button type="submit" name="updatecourse" class="btn">Update Course</button>
		  	</div>
		</form>

	</div>

</form> <!--end of id="formEditCourse"-->
